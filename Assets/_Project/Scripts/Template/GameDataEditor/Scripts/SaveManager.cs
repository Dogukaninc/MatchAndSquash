...
namespace _Project.Scripts.Template.GameDataEditor.Scripts
{
    public static class SaveManager
    {
        ...
        public static string DefaultPath => "Assets/_Project/Scripts/Template/GameDataEditor/Data/";

        private static void SaveDataAtPath(ScriptableObject so, string pathIn)
        {
#if UNITY_EDITOR

            string filePath = Application.dataPath + "/_Project/Scripts/Template/GameDataEditor/Data/" + "GameData.json";
            CreateFolder(Application.dataPath + "/_Project/Scripts/Template/GameDataEditor/Data");
#endif
...
#if UNITY_EDITOR
            string folderPath = Application.dataPath + "/_Project/Scripts/Template/GameDataEditor/Data/";
            string filePath = folderPath + "GameData.json";
            //   CreateFolder(Application.dataPath + "/_Project/Scripts/Template/GameDataEditor/Data");
#endif
