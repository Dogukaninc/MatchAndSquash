...
//             loadData.clicked += LoadData;
        ...
        {
            dataPath = "Assets/_Project/Scripts/Template/GameDataEditor/Scripts/GameData.asset";
        ...
        private void LoadUxmlAndUss()
        {
            ...
            // Import UXML
            var visualTree =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/_Project/Scripts/Template/GameDataEditor/Editor/GameDataEditor.uxml");
    ...
    {
        public static T LoadFile<T>(string path) where T : UnityEngine.Object
        {
