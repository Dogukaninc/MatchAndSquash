using System.Linq;
using _Project.Scripts.Template.GameDataEditor.Editor.DefaultPathEditor;
using _Project.Scripts.Template.GameDataEditor.Scripts;
using UnityEditor;
using UnityEngine;
using UnityEngine.UIElements;

namespace _Project.Scripts.Template.GameDataEditor.Editor
{
    public class DefaultDataController
    {
        private readonly string EditorDataHolderPath = "Assets/_Project/Scripts/Template/GameDataEditor/Editor/DefaultPathEditor/EditorDataHolder.asset";
        ...
        string _dafultDataSaveFolderPath = "/_Project/Scripts/Template/GameDataEditor/Data";
        ...
        private void CreateList()
        {
            ...
            (_addVisualElement.ElementAt(1) as Button).clicked += () =>
                AddDefaultDataPath((_addVisualElement.ElementAt(0) as TextField).text);
